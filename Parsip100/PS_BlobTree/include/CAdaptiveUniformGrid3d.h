...
public:
	...
	void Invalidate(Vol::CVolumeBox & Bounds );


	// profiling funcs
	void CalculateCellAllocationStats( const Vol::CVolumeBox & bounds,
										unsigned int & nBlocksTotal, unsigned int & nBlocksAllocated,
										unsigned int & nCellsTotal, unsigned int & nCellsAllocated );
	void CalculateCellEvaluationStats(  const Vol::CVolumeBox & bounds,
