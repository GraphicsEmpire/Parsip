...
class  CGradientBlend : public CBlobNode
{

public:
    CGradientBlend() {;}
    CGradientBlend(CBlobNode * child)
    {
        addChild(child);
    }

    CGradientBlend(CBlobNode * child1, CBlobNode * child2)
    {
        addChild(child1);
        addChild(child2);
    }
    ...
    CGradientBlend(BLOBNODECHILDREN children)
    {
        addChild(children);
    }
