...
//***********************************************************
//Taper Warping
class  CWarpShear : public CBlobTree
{
private:	
...
public:
	...
	CWarpShear(CBlobTree * child, float factor)
	{
		addChild(child);
		m_warpFactor = factor;
		m_axisAlong = xAxis;
	...
	CWarpShear(CBlobTree * child, float factor, MajorAxices axisAlong, MajorAxices axisDependant)
	{
		addChild(child);
		m_warpFactor = factor;
	...
	{
		strcpy_s(chrName, MAX_NAME_LEN, "SHEAR");		
	}
