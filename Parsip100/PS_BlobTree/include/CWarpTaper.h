...
//***********************************************************
//Taper Warping
class  CWarpTaper : public CBlobTree
{
private:
	float m_warpFactor;
...
public:
	...
	CWarpTaper(CBlobTree * child, float factor)
	{
		addChild(child);
		m_warpFactor = factor;
		m_axisTaper = xAxis;
	...
	CWarpTaper(CBlobTree * child, float factor, MajorAxices taper)
	{
		addChild(child);
		m_warpFactor = factor;
		m_axisTaper = taper;
	...
	CWarpTaper(CBlobTree * child, float factor, MajorAxices taper, MajorAxices along)
	{
		addChild(child);
		m_warpFactor = factor;
		m_axisTaper = taper;
