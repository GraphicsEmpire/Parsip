...
{    
    ...
    {
        EVENTENTRY* e = m_pendingEvents[i];
        DAnsiStr strLine = printToAStr("%s(%d) : %s : %4.2lf ms", e->strFile.c_str(), e->lineNumber, e->strFunction.c_str(), e->timeMS );
...
{
    DAnsiStr strLine = printToAStr("%4.2lf", t );
    return strLine;
}
//========================================================================================
DAnsiStr CPerfLogger::toString(int t)
{
    DAnsiStr strLine = printToAStr("%d", t );
    return strLine;
}
//========================================================================================
...
DAnsiStr CPerfLogger::toString(CPerfLogger::EVENTENTRY* e, bool bIncludeFileLine)
{
    ...
    if(bIncludeFileLine)
        strLine = printToAStr("%s(%d) : %s : %4.2lf ms", e->strFile.c_str(), e->lineNumber, e->strFunction.c_str(), e->timeMS );
    else
        strLine = printToAStr("%s : %4.2lf ms", e->strFunction.c_str(), e->timeMS );
    return strLine;
}
//========================================================================================
