...
CSketchNetCommandTranslator::CSketchNetCommandTranslator()
{
    ...
    //TX OP Maps
    m_mapTXBlobNodes[bntOpUnion]	= "UNION";
    m_mapTXBlobNodes[bntOpBlend]	= "BLEND";
    m_mapTXBlobNodes[bntOpRicciBlend]	= "BLEND";
    m_mapTXBlobNodes[bntOpDif]		= "DIFFERENCE";
    m_mapTXBlobNodes[bntOpSmoothDif]	= "DIFFERENCE";
...
bool CSketchNetCommandTranslator::translateStrToPacket( const QString& strInputCmd, SKETCHCMDPACKET& output )
{
    ...
    if(ctTokens > 0)
    {
        ...
        {            
            ...
            output.nodeType = (BlobNodeType)m_mapTokens[temp.ptr()];
...
bool CSketchNetCommandTranslator::translatePacketToStr( const SKETCHCMDPACKET& inputCmd, QString& strOutput )
{
    ...
    case(cmdAdd):
    {
        QString strSkelet = QString(m_mapTXBlobNodes[inputCmd.nodeType].c_str());
    ...
    case(cmdOperator):
    {
        QString strOp = QString(m_mapTXBlobNodes[inputCmd.nodeType].c_str());
